...
ffmpeg64: $(FFMPEG_CONFIGURE_FILES64)
	...
	cp -RL $(TOOLS_DIR64)/lib/* $(DST_DIR)/lib64
...
ffmpeg32: $(FFMPEG_CONFIGURE_FILES32)
	...
	cp -RL $(TOOLS_DIR32)/lib/* $(DST_DIR)/lib
...
ifeq ($(OSX),1)
$(FAUDIO_CONFIGURE_FILES32): export SDL2_ROOT = $(abspath $(LIBSDL_OBJ32))
endif
...
ifeq ($(OSX),1)
$(FAUDIO_CONFIGURE_FILES64): export SDL2_ROOT = $(abspath $(LIBSDL_OBJ64))
endif
...
$(WINE_CONFIGURE_FILES32): $(MAKEFILE_DEP) | $(WINE_OBJ32) $(WINE_ORDER_DEPS32)
	cd $(dir $@) && \
		STRIP=$(STRIP_QUOTED) \
		CFLAGS="-I$(abspath $(TOOLS_DIR32))/include -I$(abspath $(SRCDIR))/contrib/include -g $(COMMON_FLAGS) $(CFLAGS)" \
